...
/**
 * ManualPaymentPage — temporary UPI-QR joining flow.
 *
...
const ManualPaymentPage = () => {
  ...
  const fetchPayment = useCallback(async () => {
    if (!paymentId) return;
    try {
      const res = await mlmApi.getJoiningPayment(paymentId);
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await mlmApi.submitJoiningProof({
        paymentId,
      ...
      <div className="max-w-xl mx-auto px-4 space-y-4">
          ...
          <StatusCard
            ...
            description={
              <>
                ...
                . An admin will verify and activate your membership within
        ...
        {payment.status === "CAPTURED" && (
          <StatusCard
            ...
            description={
              <>
                Your membership is now active. Visit the Rewards dashboard to
                view your referral code and start earning.
              </>
            }
            footer={
              <button
