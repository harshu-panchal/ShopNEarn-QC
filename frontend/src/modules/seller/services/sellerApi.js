...
export const sellerApi = {
  ...
  sendVerificationOtp: (data) =>
    axiosInstance.post("/seller/verification/send-otp", data),
  verifyVerificationOtp: (data) =>
    axiosInstance.post("/seller/verification/verify-otp", data),
  sendForgotPasswordOtp: (data) =>
    axiosInstance.post("/seller/forgot-password/send-otp", data),
  verifyForgotPasswordOtp: (data) =>
    axiosInstance.post("/seller/forgot-password/verify-otp", data),
  resetForgotPassword: (data) =>
    axiosInstance.post("/seller/forgot-password/reset", data),
  // Products
  ...
  downloadBulkTemplate: () =>
    axiosInstance.get("/products/seller/bulk-template", {
      responseType: "blob",
    }),
  bulkUploadProducts: (data) =>
    axiosInstance.post("/products/seller/bulk-upload", data, {
  ...
  requestWithdrawal: (data) =>
    axiosInstance.post("/seller/request-withdrawal", data),
