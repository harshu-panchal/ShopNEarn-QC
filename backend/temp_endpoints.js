...
export const getMyLegTeam = async (req, res) => {
  try {
    ...
    const total = legMembers.length;
    const paginated = legMembers.slice((page - 1) * limit, page * limit);
...
export const getMyLevelTeam = async (req, res) => {
  try {
    ...
    const total = levelMembers.length;
    const paginated = levelMembers.slice((page - 1) * limit, page * limit);
